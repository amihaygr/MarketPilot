...
נכון לבדיקת <bdi dir="ltr"><code>2026-09-16</code></bdi>, קיימים 52 ימי מסחר
היסטוריים מאושרים ו־10 ריצות <bdi dir="ltr"><code>Backtest</code></bdi>, אך המונה החי
עומד על <bdi dir="ltr"><code>1/20</code></bdi>. הריצות היומיות האחרונות לא השלימו
את שרשרת האישור, ולכן המערכת לא ספרה אותן. זו התנהגות
