...
> <bdi dir="ltr">MarketPilot</bdi> הוא מרכז מחקר לסוחר עבור 11 נכסים ונתוני
> <bdi dir="ltr">SEC</bdi>. הוא עונה במקום
> אחד על ארבע שאלות: מה קורה עכשיו בשוק; האם הנתון טרי ואמין; האם החברה
> פרסמה דיווח רשמי שעשוי להסביר את התנועה; והאם רעיון מסחר היה עובד בעבר
> אחרי עלויות. המערכת מחברת מחירי דקה, Indicators ואיתותים מוסברים, דיווחי
> <bdi dir="ltr">SEC</bdi> ובדיקה היסטורית (<bdi dir="ltr">Backtesting</bdi>)
> מול <bdi dir="ltr">SPY</bdi>. מאחורי כל תוצאה נשמרים המקור, בדיקות האיכות
> וקו המקור (<bdi dir="ltr">Lineage</bdi>), כך שהמוצר משלב מהירות, הקשר ואמון.
> הוא תומך במחקר ובקבלת
> החלטות, אך אינו מבצע מסחר ואינו מבטיח תשואה.

**הראה:** כותרת וארבעת העקרונות בדף סיפור הפרויקט (<bdi dir="ltr">Project Story</bdi>).

**חשוב שיבינו:** בנית מוצר מחקר שימושי לסוחר, שמגובה בשרשרת אמון הנדסית.

**מעבר:** “כדי להשיג גם מהירות וגם אמינות, נתתי לכל סוג עבודה מסלול ובעלים ברורים.”

### 01:30-03:30 - הארכיטקטורה

עבור בין ארבע הלשוניות בדף סיפור הפרויקט (<bdi dir="ltr">Project Story</bdi>).
...
### 03:30-06:00 — אירוע חי (Live) מקצה לקצה
...
### 06:00-08:30 — מנתונים היסטוריים לנתונים מאושרים
...
### 08:30-10:30 — בדיקה היסטורית (Backtesting)
