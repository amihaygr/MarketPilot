...
def validate_scope() -> dict[str, object]:
    ...
    return prepare_historical_backfill_plan(
        ...
        minimum_aggregate_coverage_pct=parameters["minimum_aggregate_coverage_pct"],
...
with DAG(
    ...
    params={
        ...
        "minimum_coverage_pct": Param(
            default=35,
            type="integer",
            minimum=1,
            maximum=100,
            description="Minimum regular-session coverage required for every IEX symbol",
        ),
        "minimum_aggregate_coverage_pct": Param(
            default=80,
            type="integer",
            minimum=1,
            maximum=100,
            description="Minimum regular-session coverage required across the complete universe",
        ),
