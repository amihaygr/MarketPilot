...
def normalize(text: str) -> str:
    ...
    # Hidden directional characters are fragile in GitHub reviews and easy to
    # copy incorrectly. Direction is expressed explicitly with HTML instead.
    text = BIDI_CONTROL.sub("", text)
    stripped = text.strip()
